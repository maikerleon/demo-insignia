                ...
                <article class="col-span-2 sm:col-span-3 flex items-center sm:order-1 order-2 sm:mt-0 mt-5">
                    <div class="text-gray-600 gap-x-12 items-center justify-between">
                        <div class="flex-none space-y-5 px-4 sm:px-0 mt-5">
                            <h1 class="text-lg text-ins-800 font-bold">Jamás ha sido tan accesible y sencillo como lo es ahora...</h1>
                            <h2 class="text-4xl text-ins-900 font-extrabold sm:text-4xl">¡Actualiza, supervisa y sigue cada progreso!</h2>
                        </div>
