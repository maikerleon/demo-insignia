...
<section>
    <div class="flex justify-end">
        <ButtonLight styles="mb-4" action={createProgress} text="Agregar aprobación">
            <EyeCheckIcon styles="pr-1" />
        </ButtonLight>
    </div>
        ...
        <table class="w-full table-auto text-sm text-left">
          <thead class="bg-ins-700 text-gray-100 font-medium border-b">
            <tr>
                ...
                <th class="py-3 px-2 w-4/6">Aprobación</th>
              ...
              {#each progress as item, idx}
                  <tr class="bg-white">
                      ...
                      <td class="px-2 py-4 whitespace-nowrap font-semibold max-w-20 truncate">
                          <div class="max-w-full truncate">{item.approval_details}</div>
                      </td>
                      <td class="px-2 py-4 whitespace-nowrap font-semibold max-w-20 truncate">
                  ...
                  <tr class="bg-white">
                      <td colspan="3" class="p-4">
                          <section class="text-center flex items-center w-full justify-center">
                              ...
                              <strong class="ml-2 font-semibold text-gray-700">No se encontraron aprobaciones</strong>
                          </section>
                      </td>
                  </tr>
              {/each}
