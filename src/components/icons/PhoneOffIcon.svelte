...
<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} class="{styles} ml-2" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
